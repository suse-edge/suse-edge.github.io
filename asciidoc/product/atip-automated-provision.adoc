...
[NOTE]
====
You can refer to https://github.com/suse-edge/telco-cloud-examples/tree/main/telco-examples/edge-clusters[the SUSE Edge for Telco examples repo] for more complex examples, including IPv6 only and dual-stack configurations.
====
