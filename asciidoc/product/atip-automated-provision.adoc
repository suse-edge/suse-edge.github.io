...
[NOTE]
====
For more information about `SUSE Linux Enterprise Micro`, please check: <<components-slmicro>>

For more information about `RKE2`, please check: <<components-rke2>>

For more information about `Longhorn`, please check: <<components-longhorn>>

For more information about `NeuVector`, please check: <<components-neuvector>>
...
For more information please check out: <<components-eib>>
...
- The management server created and available to be used on the following sections. Please check the  Management Cluster section for more information. <<atip-management-cluster>>
...
The last block of information contains the Kubernetes version to be used. The `$\{RKE2_VERSION\}` is the version of `RKE2` to be used replacing this value (e.g. `v1.28.8+rke2r1`).
...
[NOTE]
====
For more information about the Telco features, please check <<atip-features>>
====
...
* The `$\{RKE2_VERSION\}` is the version of `RKE2` to be used replacing this value (e.g. `v1.28.8+rke2r1`).
