...
The script is available at https://raw.githubusercontent.com/suse-edge/atip/refs/heads/release-{version-edge-registry}/telco-examples/edge-clusters/dhcp-less/eib/custom/files/performance-settings.sh[SUSE Edge for Telco Examples repository].
