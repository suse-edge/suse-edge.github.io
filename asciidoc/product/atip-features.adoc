...
==== Bond CNI
From version 3.3 SUSE Edge is shipping the bond cni plugin. In general
terms bonding provides a method for aggregating multiple network interfaces into
a single logical "bonded" interface. We support the bond cni plugin with multus
for:
