...
The configuration and the provision based on a `Zero Touch Provisioning` (ZTP) process will be described in the <<atip-automated-provisioning,ATIP Automated Provision>> section.
