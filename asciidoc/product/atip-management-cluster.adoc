...
SUSE Linux Enterprise Micro provides `self-install ISO images` that enable you to deploy SLE Micro to your machine easily (either a virtual machine or bare metal) and configure the system on the first boot.
