...
embeddedArtifactRegistry:
  images:
    - name: registry.suse.com/rancher/hardened-cluster-autoscaler:v1.10.2-build20250909
    - name: registry.suse.com/rancher/hardened-cni-plugins:v1.8.0-build20250909
    - name: registry.suse.com/rancher/hardened-coredns:v1.12.3-build20250909
    - name: registry.suse.com/rancher/hardened-k8s-metrics-server:v0.8.0-build20250909
    - name: registry.suse.com/rancher/hardened-multus-cni:v4.2.2-build20250909
    - name: registry.suse.com/rancher/klipper-helm:v0.9.8-build20250709
    - name: registry.suse.com/rancher/mirrored-cilium-cilium:v1.18.1
    - name: registry.suse.com/rancher/mirrored-cilium-operator-generic:v1.18.1
    ...
    - name: registry.suse.com/rancher/neuvector-compliance-config:1.0.7
    - name: registry.suse.com/rancher/neuvector-controller:5.4.6
    - name: registry.suse.com/rancher/neuvector-enforcer:5.4.6
    - name: registry.suse.com/rancher/nginx-ingress-controller:v1.12.6-hardened1
