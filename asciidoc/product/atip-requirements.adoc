...
[NOTE]
====
This configuration to set the `rebootmgr` strategy, can be automated using the `ATIP ZTP workflow`. For more information, please check the <<atip-automated-provision,ATIP Automated Provision document.>>
====
