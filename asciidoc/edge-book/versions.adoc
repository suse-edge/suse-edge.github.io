...
// == Component Versions ==
:version-rancher-prime: 2.11.15
:version-cert-manager: 1.14.2
...
:version-upgrade-controller-chart: 303.0.2+up0.1.1.1
...
:release-tag-fleet-examples: release-3.3.4
:release-tag-rancher: v2.11.15
...
:version-kubernetes-k3s: v1.32.13+k3s1
:version-kubernetes-rke2: v1.32.13+rke2r1
...
:version-fleet-chart: 106.1.5+up0.12.7
...
:version-metal3-chart: 303.0.12+up0.11.7
:version-metallb-chart: 303.0.0+up0.14.9
:version-neuvector-chart: 106.0.9+up2.10.2
:version-neuvector-crd-chart: 106.0.9+up2.10.2
:version-neuvector-dashboard-extension-chart: 2.1.3
:version-rancher-chart: 2.11.15
:version-rancher-turtles-chart: 303.0.6+up0.21.0
