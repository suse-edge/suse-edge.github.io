...
:version-kubernetes-k3s: v1.33.6+k3s1
:version-kubernetes-rke2: v1.33.6+rke2r1
...
:version-neuvector-chart: 107.0.3+up2.8.10
:version-neuvector-crd-chart: 107.0.3+up2.8.10
:version-neuvector-dashboard-extension-chart: 2.1.3
:version-rancher-chart: 2.12.5
