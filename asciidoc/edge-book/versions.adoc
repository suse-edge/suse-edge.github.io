...
:chart-version-prefix: 302.0.0+up
...
:version-upgrade-controller-chart: {chart-version-prefix}0.1.1
...
:version-akri-chart: {chart-version-prefix}0.12.20
:version-akri-dashboard-extension-chart: {chart-version-prefix}1.2.1
:version-cdi-chart: {chart-version-prefix}0.4.0
:version-elemental-operator-chart: 105.0.1+up1.6.5
:version-elemental-operator-crds-chart: 105.0.1+up1.6.5
:version-endpoint-copier-operator-chart: {chart-version-prefix}0.2.1
:version-fleet-chart: 105.0.2+up0.11.2
:version-kubevirt-chart: {chart-version-prefix}0.4.0
:version-kubevirt-dashboard-extension-chart: {chart-version-prefix}1.2.1
:version-longhorn-chart: 105.1.0+up1.7.2
:version-longhorn-crd-chart: 105.1.0+up1.7.2
:version-longhorn-docs: 1.7.2
:version-metal3-chart: {chart-version-prefix}0.9.0
:version-metallb-chart: {chart-version-prefix}0.14.9
...
:version-rancher-chart: 2.10.1
:version-rancher-turtles-chart: {chart-version-prefix}0.14.1
:version-sriov-crd-chart: {chart-version-prefix}1.4.0
:version-sriov-network-operator-chart: {chart-version-prefix}1.4.0
