...
** Fix kernelArgs issue with Leap Micro 6.0: https://github.com/suse-edge/edge-image-builder/issues/498[EIB issue #498]
** Kernel cmdline arguments aren't honoured in SL Micro 6.0 for SelfInstall ISO's: https://github.com/suse-edge/edge-image-builder/issues/543[EIB issue #543]
** PackageHub inclusion in RPM resolution silently errors on SLE Micro 6.0: https://github.com/suse-edge/edge-image-builder/issues/550[EIB issue #550]
** K3S SELinux uses an outdated package: https://github.com/suse-edge/edge-image-builder/issues/565[EIB issue #565]
