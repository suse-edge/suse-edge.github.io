...
Availability Date: 7th July 2026
...
* Updated to SUSE Security (Neuvector) 5.5.1 https://open-docs.neuvector.com/releasenotes/5x/#551-april-2026[Release Notes]
* Updated Metal^3^ chart to 305.0.26+up0.13.2 with several improvements
...
* Metal^3^ chart 305.0.26+up0.13.2 contains several bugfixes
...
s| SUSE Security s| 5.5.1 s| 108.0.4+up2.8.13 s| https://charts.rancher.io/index.yaml[Rancher Charts Helm Repository] +
