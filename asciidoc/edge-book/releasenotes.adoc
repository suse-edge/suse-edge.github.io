...
* Updating from 3.4.x might introduce a https://github.com/rancher/turtles/issues/2109[CRD conflict]. If this happens, please remove `inject-ca-from` annotation from following CRDs:
[,yaml]
----
...
----
In the example, storage is set to 8GB. 
