...
s| K3s | 1.33.5 | N/A | https://github.com/k3s-io/k3s/releases/tag/v1.33.5%2Bk3s1[Upstream K3s Release]
s| RKE2 | 1.33.5 | N/A | https://github.com/rancher/rke2/releases/tag/v1.33.5%2Brke2r1[Upstream RKE2 Release]
s| SUSE Rancher Prime | 2.12.2 | 2.12.2 | https://charts.rancher.com/server-charts/prime/index.yaml[Rancher Prime Helm Repository] +
https://github.com/rancher/rancher/releases/download/v2.12.2/rancher-images.txt[Rancher 2.12.2 Container Images]
s| SUSE Storage (Longhorn) | 1.9.1 | 107.1.0+up1.9.1 | https://charts.rancher.io/index.yaml[Rancher Charts Helm Repository] +
...
s| SUSE Security | 5.4.6 | 107.0.1+up2.8.8 | https://charts.rancher.io/index.yaml[Rancher Charts Helm Repository] +
