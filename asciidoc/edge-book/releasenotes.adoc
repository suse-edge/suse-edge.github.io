...
s| K3s s| 1.31.5 | N/A | https://github.com/k3s-io/k3s/releases/tag/v1.31.5%2Bk3s1[Upstream K3s Release]
s| RKE2 s| 1.31.5 | N/A | https://github.com/rancher/rke2/releases/tag/v1.31.5%2Brke2r1[Upstream RKE2 Release]
