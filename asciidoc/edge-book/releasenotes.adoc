...
* Updated to Kubernetes 1.33.5 and Rancher Prime 2.12.2 https://github.com/rancher/rancher/releases/tag/v2.11.6[Release Notes]
...
s| K3s s| 1.33.5 s| N/A s| https://github.com/k3s-io/k3s/releases/tag/v1.33.5%2Bk3s1[Upstream K3s Release]
s| RKE2 s| 1.33.5 s| N/A s| https://github.com/rancher/rke2/releases/tag/v1.33.5%2Brke2r1[Upstream RKE2 Release]
s| SUSE Rancher Prime s| 2.12.2 s| 2.12.2 s| https://charts.rancher.com/server-charts/prime/index.yaml[Rancher Prime Helm Repository] + 
https://github.com/rancher/rancher/releases/download/v2.12.2/rancher-images.txt[Rancher 2.12.2 Container Images]
s| SUSE Storage (Longhorn) s| 1.9.1 s| 107.1.0+up1.9.1 s| https://charts.rancher.io/index.yaml[Rancher Charts Helm Repository] +
...
s| SUSE Security s| 5.4.6 s| 107.0.1+up2.8.8 s| https://charts.rancher.io/index.yaml[Rancher Charts Helm Repository] +
