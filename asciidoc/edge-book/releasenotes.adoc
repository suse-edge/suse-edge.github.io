...
* EIB now supports disks which are >512 byte sector size: https://github.com/suse-edge/edge-image-builder/issues/447
...
Download the SUSE Edge Container public key from https://www.suse.com/support/security/keys/
