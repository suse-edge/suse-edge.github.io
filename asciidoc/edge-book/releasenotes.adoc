...
| SLE Micro | 5.5 (latest) | N/A | https://www.suse.com/download/sle-micro/[https://www.suse.com/download/sle-micro/]
| K3s | 1.28.8 | N/A | https://github.com/k3s-io/k3s/releases/tag/v1.28.8%2Bk3s1
| RKE2 | 1.28.8 | N/A | https://github.com/rancher/rke2/releases/tag/v1.28.8%2Brke2r1
...
| NeuVector| 5.3.0 | 103.0.3 | rancher/mirrored-neuvector-controller:5.3.0 rancher/mirrored-neuvector-enforcer:5.3.0 rancher/mirrored-neuvector-manager:5.3.0 rancher/mirrored-neuvector-prometheus-exporter:5.3.0 rancher mirrored-neuvector-registry-adapter:0.1.1-s1 rancher/mirrored-neuvector-scanner:latest rancher/mirrored-neuvector-updater:latest
...
| Akri (Tech Preview) | 0.12.20 | 0.12.20 | registry.suse.com/edge/akri-chart:0.12.20 registry.suse.com/edge/akri-agent:v0.12.20 registry.suse.com/edge/akri-controller:v0.12.20 registry.suse.com/edge/akri-debug-echo-discovery-handler:v0.12.20 registry.suse.com/edge/akri-onvif-discovery-handler:v0.12.20 registry.suse.com/edge/akri-opcua-discovery-handler:v0.12.20 registry.suse.com/edge/akri-udev-discovery-handler:v0.12.20 registry.suse.com/edge/akri-webhook-configuration:v0.12.20 registry.suse.com/edge/akri-dashboard-extension-chart:1.0.0
|======

> NOTE

SUSE Edge z-stream releases are tightly integrated and throroughly tested as a versioned stack. Upgrade of any individual components to a different versions to those listed above is likely to result in system downtime. While it's possible to run Edge clusters in untested configurations, it is not recommended, and it may take longer to provide resolution through the support channels.
