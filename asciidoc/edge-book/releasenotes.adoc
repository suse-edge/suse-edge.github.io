...
| SUSE Multi-Linux Manager | 5.0.2 | N/A | https://www.suse.com/download/suse-manager/[SUSE Manager Download Page]
...
| SUSE Rancher Prime | 2.10.1 | 2.10.1 | https://github.com/rancher/rancher/releases/download/v2.10.1/rancher-images.txt[Rancher 2.10.1 Images] +
...
| Elemental Dashboard Extension | 3.0.0 | 3.0.0 | link:https://github.com/rancher/ui-plugin-charts/tree/3.2.0/charts/elemental/3.0.0[Elemental Extension chart]
...
| Endpoint Copier Operator | 0.2.0 | 302.0.0+up0.2.1 | registry.suse.com/edge/3.2/endpoint-copier-operator:302.0.0_up0.2.1 +
registry.suse.com/edge/3.2/endpoint-copier-operator-chart:0.2.0
...
| System Upgrade Controller | 0.14.2 | 105.0.1 | link:https://charts.rancher.io[System Upgrade Controller chart] +
