...
Availability Date: 17th July 2026
...
Summary: SUSE Edge 3.3.4 is the forth z-stream release in the SUSE Edge 3.3 release stream.

== New Features

* Updated to Kubernetes 1.32.13 and Rancher Prime 2.11.15 https://github.com/rancher/rancher/releases/tag/v2.11.15[Release Notes]
* Updated to SUSE Security (Neuvector) 5.5.2 https://open-docs.neuvector.com/5.5/releasenotes/5x[Release Notes]
* Updated Metal^3^ chart to 303.0.12+up0.11.7 with several improvements
* Updated Upgrade Controller chart to 305.0.2+up0.1.1.1

== Bug & Security Fixes

* Rancher Prime 2.11.15 contains several bugfixes and security fixes https://github.com/rancher/rancher/releases/tag/v2.11.15[Upstream Rancher Release Notes]
...
The following table describes the individual components that make up the 3.3.4 release, including the version, the Helm chart version (if applicable), and from where the released artifact can be pulled in the binary format. Please follow the associated documentation for usage and deployment examples.
...
s| K3s s| 1.32.13 | N/A s| https://github.com/k3s-io/k3s/releases/tag/v1.32.13%2Bk3s1[Upstream K3s Release]
s| RKE2 s| 1.32.13 | N/A s| https://github.com/rancher/rke2/releases/tag/v1.32.13%2Brke2r1[Upstream RKE2 Release]
s| SUSE Rancher Prime s| 2.11.15 s| 2.11.15 s| https://charts.rancher.com/server-charts/prime/index.yaml[Rancher Prime Helm Repository] +
https://prime.ribs.rancher.io/rancher/v2.11.15/rancher-images.txt[Rancher 2.11.15 Container Images]
...
s| SUSE Security s| 5.5.2 s| 106.0.9+up2.10.2 | https://charts.rancher.io/index.yaml[Rancher Charts Helm Repository] +
...
| Rancher Turtles (CAPI) | 0.21.0 | 303.0.6+up0.21.0 | *registry.suse.com/edge/charts/rancher-turtles:303.0.6_up0.21.0* +
...
| Rancher Turtles Airgap Resources | 0.21.0 | 303.0.6+up0.21.0 s| registry.suse.com/edge/charts/rancher-turtles-airgap-resources:303.0.6_up0.21.0
| Metal^3^ | 0.11.7 | 303.0.12+up0.11.7 | registry.suse.com/edge/charts/metal3:303.0.7_up0.11.5 +
...
registry.suse.com/edge/3.3/kube-rbac-proxy:0.18.1
...
| Edge Image Builder | 1.2.1.1 | N/A | registry.suse.com/edge/3.3/edge-image-builder:1.2.1.1
...
| Upgrade Controller | 0.1.1. | 303.0.2+up0.1.1.1 | registry.suse.com/edge/charts/upgrade-controller:303.0.1_up0.1.1.1 +
registry.suse.com/edge/3.3/upgrade-controller:0.1.1.1 +
registry.suse.com/edge/3.3/kubectl:1.32.13 +
*registry.suse.com/edge/3.3/release-manifest:3.3.4*
...
https://prime.ribs.rancher.io/rancher/v2.11.6/rancher-images.txt[Rancher 2.11.6 Container Images]
| SUSE Storage | 1.8.2 | 106.2.1+up1.8.2 | https://charts.rancher.io/index.yaml[Rancher Charts Helm Repository] +
*registry.suse.com/rancher/mirrored-longhornio-csi-attacher:v4.9.0* +
*registry.suse.com/rancher/mirrored-longhornio-csi-provisioner:v5.3.0* +
registry.suse.com/rancher/mirrored-longhornio-csi-resizer:v1.13.2 +
