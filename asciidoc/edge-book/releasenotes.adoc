...
| Longhorn | 1.7.1 | 1.7.1 | https://raw.githubusercontent.com/longhorn/longhorn/v1.7.1/deploy/longhorn-images.txt[Longhorn 1.7.1 Images] +
...
s| Metal^3^ s| 1.16.0 s| 0.8.1 | registry.suse.com/edge/metal3-chart:0.8.1 +
...
| Elemental | 1.6.4 | 1.6.4 | registry.suse.com/rancher/elemental-operator-chart:1.6.4 +
registry.suse.com/rancher/elemental-operator-crds-chart:1.6.4 +
registry.suse.com/rancher/elemental-operator:1.6.4
| Edge Image Builder | 1.1 | N/A | registry.suse.com/edge/edge-image-builder:1.1
...
registry.suse.com/edge/akri-dashboard-extension-chart:1.1.0 +
