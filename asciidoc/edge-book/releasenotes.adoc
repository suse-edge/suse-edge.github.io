...
Availability Date: 6th July 2026
...
Summary: SUSE Edge 3.5.2 is the second z-stream release in the SUSE Edge 3.5 release stream.

== New Features

* Updated to Kubernetes 1.34.7 and Rancher Prime 2.13.6
* Updated to SUSE Storage (Longhorn) 1.10.2 https://longhorn.io/docs/1.10.2/[Upstream Longhorn Release Notes]
* Updated Metal^3^ chart to 305.0.25+up0.13.2 with several improvements
* Updated Upgrade Controller chart to 305.0.3+up0.1.3

== Bug & Security Fixes

* Rancher Prime 2.13.6 contains several bugfixes and security fixes https://github.com/rancher/rancher/releases/tag/v2.13.6[Upstream Rancher Release Notes]
* Updated Rancher Turtles Providers (CAPI) to 305.0.5+up0.25.4
* Metal^3^ chart 305.0.25+up0.13.2 contains several bugfixes
...
The following table describes the individual components that make up the 3.5.2 release, including the version, the Helm chart version (if applicable), and from where the released artifact can be pulled in the binary format. Please follow the associated documentation for usage and deployment examples.
...
| SUSE Multi-Linux Manager | 5.1.2 | N/A | https://www.suse.com/download/suse-manager/[SUSE Multi-Linux Manager Download Page]
s| K3s s| 1.34.7 s| N/A s| https://github.com/k3s-io/k3s/releases/tag/v1.34.7%2Bk3s1[Upstream K3s Release]
s| RKE2 s| 1.34.7 s| N/A s| https://github.com/rancher/rke2/releases/tag/v1.34.7%2Brke2r1[Upstream RKE2 Release]
s| SUSE Rancher Prime s| 2.13.6 s| 2.13.6 s| https://charts.rancher.com/server-charts/prime/index.yaml[Rancher Prime Helm Repository] +
https://prime.ribs.rancher.io/rancher/v2.13.6/rancher-images.txt[Rancher 2.13.6 Container Images]
| SUSE Storage (Longhorn) | 1.10.2 | 1.10.2 | https://apps.rancher.io/applications/suse-storage[SUSE Storage Helm Repository] +
https://apps.rancher.io/applications/suse-storage/components[SUSE Storage Container Images]
| SUSE Security | 5.4.9 | 108.0.2+up2.8.11 | https://charts.rancher.io/index.yaml[Rancher Charts Helm Repository] +
...
| Rancher Turtles Providers (CAPI) | 0.25.4 | 305.0.5+up0.25.4 | registry.suse.com/edge/charts/rancher-turtles-providers:305.0.5+up0.25.4 +
...
s| Metal^3^ s| 0.13.2 s| 305.0.25+up0.13.2 s| registry.suse.com/edge/charts/metal3:305.0.25+up0.13.2 +
...
| KubeVirt Dashboard Extension | 1.3.3 | 305.0.4+up1.3.3 | registry.suse.com/edge/charts/kubevirt-dashboard-extension:305.0.4+up1.3.3
| Containerized Data Importer | 1.62.0 | 305.0.1+up0.6.0 | registry.suse.com/edge/charts/cdi:305.0.1+up0.6.0 +
...
| Akri (Deprecated) | 0.12.20 | 305.0.0+up0.12.20 | registry.suse.com/edge/charts/akri:305.0.0+up0.12.20 +
...
Availability Date: 18th March 2026
...
Summary: SUSE Edge 3.5.1 is the first z-stream release in the SUSE Edge 3.5 release stream.

== New Features

* Updated to Kubernetes 1.34.4 and Rancher Prime 2.13.3
* Updated to SUSE Storage (Longhorn) 1.10.2 https://longhorn.io/docs/1.10.2/[Upstream Longhorn Release Notes]
...
* Rancher Prime 2.13.3 contains several bugfixes https://github.com/rancher/rancher/releases/tag/v2.13.3[Upstream Rancher Release Notes]
* SUSE Storage (Longhorn) 1.10.2 contains several bugfixes https://github.com/longhorn/longhorn/releases/tag/v1.10.2[Upstream Longhorn Bug Fixes]
* SUSE Security (Neuvector) 5.4.8 contains several bugfixes https://open-docs.neuvector.com/releasenotes/5x/#bugs-fixed[Upstream Neuvector Bug Fixes]
* EIB (edge-image-builder) 1.3.3 contains several bugfixes https://github.com/suse-edge/edge-image-builder/blob/release-1.3/RELEASE_NOTES.md#bug-fixes[EIB Bug Fixes]
* Updated Metal3 chart with several bugfixes
...
The following table describes the individual components that make up the 3.5.1 release, including the version, the Helm chart version (if applicable), and from where the released artifact can be pulled in the binary format. Please follow the associated documentation for usage and deployment examples.
...
SL-Micro.x86_64-6.2-Base-GM.raw.xz (sha256 bea3ac202b54ee29fabc28568f50c86d34939cf861679f21a91dfbae9c54c92e) +
SL-Micro.x86_64-6.2-Base-RT-GM.raw.xz (sha256 b9af7763c8d63143e31e5f80eb8d06fcc9477a576de8e358ab2e9835ab39d305) +
s| SUSE Multi-Linux Manager s| 5.1.2 s| N/A s| https://www.suse.com/download/suse-manager/[SUSE Multi-Linux Manager Download Page]
s| K3s s| 1.34.4 s| N/A s| https://github.com/k3s-io/k3s/releases/tag/v1.34.4%2Bk3s1[Upstream K3s Release]
s| RKE2 s| 1.34.4 s| N/A s| https://github.com/rancher/rke2/releases/tag/v1.34.4%2Brke2r1[Upstream RKE2 Release]
s| SUSE Rancher Prime s| 2.13.3 s| 2.13.3 s| https://charts.rancher.com/server-charts/prime/index.yaml[Rancher Prime Helm Repository] +
https://prime.ribs.rancher.io/rancher/v2.13.3/rancher-images.txt[Rancher 2.13.3 Container Images]
s| SUSE Storage (Longhorn) s| 1.10.2 s| 1.10.2 s| https://apps.rancher.io/applications/suse-storage[SUSE Storage Helm Repository] +
https://apps.rancher.io/applications/suse-storage/components[SUSE Storage Container Images]
s| SUSE Security s| 5.4.9 s| 108.0.2+up2.8.11 s| https://charts.rancher.io/index.yaml[Rancher Charts Helm Repository] +
registry.suse.com/rancher/neuvector-controller:5.4.9 +
registry.suse.com/rancher/neuvector-enforcer:5.4.9 +
registry.suse.com/rancher/neuvector-manager:5.4.9 +
registry.suse.com/rancher/neuvector-compliance-config:1.0.9 +
...
registry.suse.com/rancher/neuvector-scanner:6 +
registry.suse.com/rancher/neuvector-updater:0.0.7
s| Rancher Turtles Providers (CAPI) s| 0.25.4 s| 305.0.5+up0.25.4 s| registry.suse.com/edge/charts/rancher-turtles-providers:305.0.5+up0.25.4 +
registry.rancher.com/rancher/cluster-api-metal3-controller:v1.10.4 +
registry.rancher.com/rancher/cluster-api-metal3-ipam-controller:v1.10.4 +
registry.suse.com/rancher/cluster-api-provider-rke2-bootstrap:v0.21.1 +
registry.suse.com/rancher/cluster-api-provider-rke2-controlplane:v0.21.1
