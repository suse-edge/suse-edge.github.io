...
| SUSE Rancher Prime | 2.10.1 | 2.10.1 | https://charts.rancher.com/server-charts/prime[Rancher Prime Helm Repository] +
https://github.com/rancher/rancher/releases/download/v2.10.1/rancher-images.txt[Rancher 2.10.1 Container Images]
| SUSE Storage | 1.7.2 | 105.1.0+up1.7.2 | https://github.com/rancher/charts/tree/release-v2.10/charts/longhorn-crd/105.1.0%2Bup1.7.2[Longhorn CRD Helm Chart] +
https://github.com/rancher/charts/tree/release-v2.10/charts/longhorn/105.1.0%2Bup1.7.2[Longhorn Helm Chart] +
...
| System Upgrade Controller | 0.14.2 | 105.0.1 | https://github.com/rancher/charts/tree/release-v2.10/charts/system-upgrade-controller/105.0.1[System Upgrade Controller Helm Chart] +
