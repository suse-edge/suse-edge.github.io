...
Install https://cluster-api.sigs.k8s.io/user/quick-start.html#install-clusterctl[clusterctl] 1.6.x, then we will install the core, infrastructure, bootstrap and controlplane providers as follows:
