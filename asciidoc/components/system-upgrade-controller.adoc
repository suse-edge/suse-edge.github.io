...
== How does {product} use System Upgrade Controller?

{product} uses `SUC` to facilitate various "Day 2" operations related to OS and Kubernetes version upgrades on management and downstream clusters.
