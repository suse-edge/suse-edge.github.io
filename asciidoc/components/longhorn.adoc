...
[TIP]
====
For additional help installing open-iscsi, refer to the https://longhorn.io/docs/1.7.3/deploy/install/#installing-open-iscsi[official Longhorn documentation].
====

=== Installing Longhorn

There are several ways to install Longhorn on your Kubernetes clusters.
This guide will follow through the Helm installation, however feel free to follow the https://longhorn.io/docs/1.7.3/deploy/install/[official documentation] if another approach is desired.
...
however, we suggest to familiarize yourself with the https://longhorn.io/docs/1.7.3/terminology/[terminology documentation] that Longhorn offers.
====
