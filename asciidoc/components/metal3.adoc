...
which enables management of infrastructure resources across multiple
infrastructure providers via broadly adopted vendor-neutral APIs, and uses
Metal3 as an infrastructure backend for Machine objects.  
...
provisions or deprovisions downstream clusters, Metal^3^ will do things like: +

* Mount and umount Virtual media for Media devices
* Power on and power off servers
