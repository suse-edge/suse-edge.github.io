...
== Best Practices
Installation of MetalLB in L2 mode is detailed in <<guides-metallbk3s,the MetalLB guide>>.

A guide on installing MetalLB in front of the kube-api-server to achieve HA setups can be found in the <<guides-metallb-kubernetes>> turotial.
