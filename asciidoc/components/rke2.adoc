...
== How does {product} use RKE2?

RKE2 is a fundamental piece of the {product} stack. It sits on top of
...
The recommended way of installing RKE2 as part of the {product} stack is by using Edge Image Builder (EIB). See the <<components-eib,EIB documentation>> for more details on how to configure it to deploy RKE2.
