...
* At least one physical host with SLE Micro {version-operatingsystem} installed, and with virtualization extensions enabled in the BIOS (see {link-virtualization-sles}[here] for details).
