...
[,shell]
----
$ helm install kubevirt-chart oci://registry.suse.com/edge/kubevirt-chart --namespace kubevirt-system --create-namespace
$ helm install cdi-chart oci://registry.suse.com/edge/cdi-chart --namespace cdi-system --create-namespace
----
