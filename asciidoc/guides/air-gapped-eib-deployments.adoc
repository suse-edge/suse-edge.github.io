...
embeddedArtifactRegistry:
  images:
    ...
    - name: registry.rancher.com/rancher/rancher-agent:v2.13.3
    ...
    - name: registry.rancher.com/rancher/rke2-cloud-provider:v1.34.4-0.20260211145917-c6017918a65c-build20260211
