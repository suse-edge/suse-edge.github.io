...
embeddedArtifactRegistry:
  images:
    - name: registry.rancher.com/rancher/backup-restore-operator:v8.1.1
    - name: registry.rancher.com/rancher/compliance-operator:v1.2.2
    - name: registry.rancher.com/rancher/fleet-agent:v0.13.5
    - name: registry.rancher.com/rancher/fleet:v0.13.5
    - name: registry.rancher.com/rancher/hardened-addon-resizer:1.8.23-build20250909
    - name: registry.rancher.com/rancher/hardened-calico:v3.30.3-build20250909
    ...
    - name: registry.rancher.com/rancher/hardened-dns-node-cache:1.26.0-build20250909
    - name: registry.rancher.com/rancher/hardened-etcd:v3.5.21-k3s1-build20250910
    - name: registry.rancher.com/rancher/hardened-flannel:v0.27.3-build20250901
    ...
    - name: registry.rancher.com/rancher/hardened-multus-thick:v4.2.2-build20250909
    - name: registry.rancher.com/rancher/hardened-whereabouts:v0.9.2-build20250909
    - name: registry.rancher.com/rancher/k3s-upgrade:v1.33.5-k3s1
    - name: registry.rancher.com/rancher/klipper-helm:v0.9.8-build20250709
    - name: registry.rancher.com/rancher/klipper-lb:v0.4.13
    - name: registry.rancher.com/rancher/kubectl:v1.33.5
    - name: registry.rancher.com/rancher/kuberlr-kubectl:v5.0.1
    ...
    - name: registry.rancher.com/rancher/rancher-agent:v2.12.4
    ...
    - name: registry.rancher.com/rancher/rke2-runtime:v1.33.5-rke2r1
    - name: registry.rancher.com/rancher/rke2-upgrade:v1.33.5-rke2r1
    - name: registry.rancher.com/rancher/scc-operator:v0.3.1
    - name: registry.rancher.com/rancher/security-scan:v0.7.4
    - name: registry.rancher.com/rancher/shell:v0.5.1
    - name: registry.rancher.com/rancher/system-agent-installer-k3s:v1.33.5-k3s1
    - name: registry.rancher.com/rancher/system-agent-installer-rke2:v1.33.5-rke2r1
    ...
    - name: registry.rancher.com/rancher/ui-plugin-catalog:4.0.10
