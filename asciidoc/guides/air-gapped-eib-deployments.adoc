...
embeddedArtifactRegistry:
  images:
    - name: registry.rancher.com/rancher/backup-restore-operator:v6.0.2
    - name: registry.rancher.com/rancher/calico-cni:v3.30.2-rancher1
    - name: registry.rancher.com/rancher/cis-operator:v1.3.9
    - name: registry.rancher.com/rancher/flannel-cni:v1.4.1-rancher1
    - name: registry.rancher.com/rancher/fleet-agent:v0.11.11
    - name: registry.rancher.com/rancher/fleet:v0.11.11
    ...
    - name: registry.rancher.com/rancher/hardened-kubernetes:v1.31.12-rke2r1-build20250814
    ...
    - name: registry.rancher.com/rancher/k3s-upgrade:v1.31.12-k3s1
    ...
    - name: registry.rancher.com/rancher/prometheus-federator:v2.0.1
    - name: registry.rancher.com/rancher/pushprox:v0.1.7
    - name: registry.rancher.com/rancher/rancher-agent:v2.10.10
    - name: registry.rancher.com/rancher/rancher-csp-adapter:v5.0.1
    - name: registry.rancher.com/rancher/rancher-webhook:v0.6.11
    - name: registry.rancher.com/rancher/rancher:v2.10.10
    - name: registry.rancher.com/rancher/rke-tools:v0.1.114
    - name: registry.rancher.com/rancher/rke2-cloud-provider:v1.31.9-rc1.0.20250516171836-812206503b28-build20250612
    - name: registry.rancher.com/rancher/rke2-runtime:v1.31.12-rke2r1
    - name: registry.rancher.com/rancher/rke2-upgrade:v1.31.12-rke2r1
    - name: registry.rancher.com/rancher/security-scan:v0.5.7
    - name: registry.rancher.com/rancher/shell:v0.3.1
    - name: registry.rancher.com/rancher/system-agent-installer-k3s:v1.31.12-k3s1
    - name: registry.rancher.com/rancher/system-agent-installer-rke2:v1.31.12-rke2r1
