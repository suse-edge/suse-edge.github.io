...
The https://github.com/rancher/rancher/releases/tag/v2.9.12[Rancher v2.9.12] release assets contain a `rancher-images.txt` which can be seen https://prime.ribs.rancher.io/rancher/v2.9.12/rancher-images.txt[here] file which lists all the images required for an air-gapped installation.
...
embeddedArtifactRegistry:
  images:
    ...
    - name: registry.rancher.com/rancher/kuberlr-kubectl:v3.0.1
...
The https://longhorn.io/docs/1.7.3/deploy/install/airgap/[official documentation] for Longhorn contains a
