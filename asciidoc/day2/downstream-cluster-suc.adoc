...
. *Watch -> Revision* - choose a link:https://github.com/suse-edge/fleet-examples/releases[release] tag for the `suse-edge/fleet-examples` repository that you wish to use, e.g. `edge-3.0.0`.
...
system-upgrade-controller   https://github.com/suse-edge/fleet-examples.git   edge-3.0.0   0/0                       
----
