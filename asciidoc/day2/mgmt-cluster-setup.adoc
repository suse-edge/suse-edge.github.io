...
* A `base-images` directory holding the base image from which EIB will build the management image
...
* `SLE-Micro.x86_64-5.5.0-Default-SelfInstall-GM.install.iso` as a base image
