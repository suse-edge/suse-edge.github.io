...
The documentation is written in Asciidoc(tor). Start with a very basic link:teamplate.adoc[Template].
...
The easiest way::
+
*Install https://docs.asciidoctor.org/asciidoctor/latest/tooling/#web-browser-add-ons-preview-only[a browser extension] and preview edge-book/adge.adoc in your browser.
