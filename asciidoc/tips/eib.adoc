...
For more information, please refer to the https://documentation.suse.com/sles/15-SP7/html/SLES-all/cha-mod.html#sec-mod-modprobe-d["Managing kernel modules" section of the SUSE Linux Enterprise Server Documentation]
