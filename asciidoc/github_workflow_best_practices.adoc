...
Some repositories require to sign-off the commits to acknowledge that you have read and agreed with the rules and licensing of the repository/project.

When committing the changes, just append the `-s` or `--signoff` flag to the commit command as:
