...
En este ejemplo, la contraseña de root sería «root». Consultad <<id-configuring-os-users>> para crear hashes de contraseña para la contraseña segura que queráis utilizar.
