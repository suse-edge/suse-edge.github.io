...
* A functional Kubernetes cluster with SUSE Storage {version-longhorn} installed
* The V2 Data Engine enabled and prepared as described in <<guides-suse-storage-v2-data-engine>>
