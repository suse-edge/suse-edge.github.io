...
:toc: preamble
:previous-edge-version: 3.6
:static-edge-version: 3.7.0
:static-fleet-examples-tag: release-3.7.0
...
. Charts scheduled for an upgrade *must* be upgraded to versions compatible with the `{product} {static-edge-version}` release. For a list of the `{product} {static-edge-version}` components, refer to <<release-notes-3-7-0>>.
