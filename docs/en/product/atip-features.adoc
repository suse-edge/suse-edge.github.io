...
image::product-atip-ptp-scenario-bc-single-nic.png[Scenario 2a - Boundary Clock (PTP-only) with Multiport Single NIC including propagation to Ordinary Clock server,scaledwidth=100%]
...
image::product-atip-ptp-scenario-bc-multi-nic-dpll.png[Scenario 3a - Boundary Clock (PTP-only) multi-NIC with internal timing module (DPLL GNR-D based),scaledwidth=100%]
