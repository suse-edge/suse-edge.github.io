...
[WARNING]
====
The SUSE Multi-Linux Manager version included with {product} {version} ({mlm-docs-version}) doesn't support SUSE Linux Micro 6.2 yet. It will be updated and supported in future {product} {version} releases.
====
...
In this quick start we're using the "qcow2" image `SUSE-Multi-Linux-Manager-Server.x86_64-5.1.5-Qcow-5.1-2026-08.qcow2` for {x86-64} that you can find at https://www.suse.com/download/suse-manager/ or in the SUSE Customer Center. This image will work as a virtual machine on hypervisors like KVM. Please always check for the newest version of the image and use it for new installations.
