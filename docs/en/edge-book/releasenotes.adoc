...
s| K3s s| 1.35.4 s| N/A s| https://github.com/k3s-io/k3s/releases/tag/v1.35.4%2Bk3s1[Upstream K3s Release]
s| RKE2 s| 1.35.4 s| N/A s| https://github.com/rancher/rke2/releases/tag/v1.35.4%2Brke2r1[Upstream RKE2 Release]
s| SUSE Rancher Prime s| 2.14.2 s| 2.14.2 s| https://charts.rancher.com/server-charts/prime/index.yaml[Rancher Prime Helm Repository] +
https://prime.ribs.rancher.io/rancher/v2.14.2/rancher-images.txt[Rancher 2.14.2 Container Images]
s| SUSE Storage (Longhorn) s| 1.11.2 s| 1.11.2 s| https://apps.rancher.io/applications/suse-storage[SUSE Storage Helm Repository] +
https://apps.rancher.io/applications/suse-storage/components[SUSE Storage Container Images]
| SUSE Security (NeuVector) s| 5.5.2 s| 109.0.2+up2.10.2 s| https://charts.rancher.io/index.yaml[Rancher Charts Helm Repository] +
