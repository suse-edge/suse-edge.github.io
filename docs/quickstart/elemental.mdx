...
:::tip 
If you don't want to deal with setting up DNS (for example this is just an ephemeral test server), you can use a service like [sslip.io](https://sslip.io). With this service, you can resolve any ip address with `<address>.sslip.io`. 
:::
...
<Tabs>
  ...
  TODO: MachineSelectorTemplate and Cluster
