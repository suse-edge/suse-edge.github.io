...
If you don't want to deal with setting up DNS (for example this is just an ephemeral test server), you can use a service like [sslip.io](sslip.io). With this, you can take you  
