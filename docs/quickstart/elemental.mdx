...
![Installing Elemental Extension1](./images/installing-elemental-extension-2.png)

Confirm that you want to install the extension: 

![Installing Elemental Extension1](./images/installing-elemental-extension-3.png)

After this installs, you will be prompted to reload the page. 

![Installing Elemental Extension1](./images/installing-elemental-extension-4.png)

Once you reload, you can access the Elemental Extension through the "OS Management" global app. 

![Installing Elemental Extension1](./images/accessing-elemental-extension.png)

TODO: annotate screenshots

TODO: retake screenshots with Elemental 1.4 once released
