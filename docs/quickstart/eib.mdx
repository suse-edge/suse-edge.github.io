...
This directory has the following structure (elemental and rpms subdirectories are optional):
...
This will create a timestamped folder in `$PWD/eib/_build/` that includes the produced iso image.
